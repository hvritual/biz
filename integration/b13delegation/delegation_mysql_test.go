...
func TestB132TenantDelegationPersistenceLifecycle(t *testing.T) {
	...
	tenantService, err := tenantlifecycle.Build(tenantRepositories, tenantLifecycleCapabilities{})
	if err != nil {
		t.Fatal(err)
	}
...
func (tenantLifecycleCapabilities) CommercialSubscriptionManagement() accessapp.TenantLifecycleToCommercialSubscriptionManagementChildCapability {
	return nil
}
