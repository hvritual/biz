...
type TenantMemberBusinessScopeOperationHandler struct {
	application application.TenantMemberBusinessScopeApplication
	executor    operation.Executor
}

func RegisterTenantMemberBusinessScopeOperationExecutor(mux *http.ServeMux, application application.TenantMemberBusinessScopeApplication, executor operation.Executor) error {
	if mux == nil {
	...
	handler := &TenantMemberBusinessScopeOperationHandler{application: application, executor: executor}
...
func writeTenantMemberBusinessScopeOperationError(writer http.ResponseWriter, err error) {
...
func (handler *TenantMemberBusinessScopeOperationHandler) handleOperationGetTenantMemberBusinessScope(writer http.ResponseWriter, request *http.Request) {
	...
	output, err := operation.ExecuteTyped(callContext, handler.executor, policy.OperationPlanTenantMemberBusinessScopeGetTenantMemberBusinessScope(), wire, handler.application.GetTenantMemberBusinessScope)
	if err != nil {
		writeTenantMemberBusinessScopeOperationError(writer, err)
		return
	}
...
func (handler *TenantMemberBusinessScopeOperationHandler) handleOperationListTenantMemberScopeCandidates(writer http.ResponseWriter, request *http.Request) {
	...
	callContext := execution.WithIdempotencyKey(request.Context(), request.Header.Get("Idempotency-Key"))
	output, err := operation.ExecuteTyped(callContext, handler.executor, policy.OperationPlanTenantMemberBusinessScopeListTenantMemberScopeCandidates(), wire, handler.application.ListTenantMemberScopeCandidates)
	if err != nil {
		writeTenantMemberBusinessScopeOperationError(writer, err)
		return
	}
...
func (handler *TenantMemberBusinessScopeOperationHandler) handleOperationSetTenantMemberBusinessScope(writer http.ResponseWriter, request *http.Request) {
	...
	wire.UserId = request.PathValue("user_id")
	callContext := execution.WithIdempotencyKey(request.Context(), request.Header.Get("Idempotency-Key"))
	output, err := operation.ExecuteTyped(callContext, handler.executor, policy.OperationPlanTenantMemberBusinessScopeSetTenantMemberBusinessScope(), wire, handler.application.SetTenantMemberBusinessScope)
	if err != nil {
		writeTenantMemberBusinessScopeOperationError(writer, err)
		return
	}
