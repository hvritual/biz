...
const AssemblyPlanDigest = "9babb929302fa7ea4e024eeec106b2df9eaebdcbe3c274789fa4cee32a9c7d37"
...
type Applications struct {
	AccessTenantAuditManagement      accessapplication.TenantAuditManagementApplication
...
func BuildApplications(factories ApplicationFactories, executor operation.Executor) (Applications, error) {
	...
	var err error
	applications.AccessTenantAuditManagement, err = factories.BuildAccessTenantAuditManagement(AccessTenantAuditManagementDependencies{})
	if err != nil {
		return Applications{}, fmt.Errorf("yunka assembly: build application access/tenant_audit_management: %w", err)
	}
	if applications.AccessTenantAuditManagement == nil {
		return Applications{}, errors.New("yunka assembly: application factory returned nil for access/tenant_audit_management")
	}
	...
	applications.AccessTenantProfileManagement, err = factories.BuildAccessTenantProfileManagement(AccessTenantProfileManagementDependencies{})
	if err != nil {
		return Applications{}, fmt.Errorf("yunka assembly: build application access/tenant_profile_management: %w", err)
	}
...
func RegisterTransports(bindings TransportBindings, applications Applications, executor operation.Executor) error {
	...
	if applications.AccessTenantAuditManagement == nil {
		return errors.New("yunka assembly: application access/tenant_audit_management is required for transport registration")
	}
	if err := accessrest.RegisterTenantAuditManagementOperationExecutor(bindings.HTTP, applications.AccessTenantAuditManagement, executor); err != nil {
		return fmt.Errorf("yunka assembly: register HTTP access/tenant_audit_management: %w", err)
	}
	if err := accessrpc.RegisterTenantAuditManagementOperationExecutor(bindings.RPC, applications.AccessTenantAuditManagement, executor); err != nil {
		return fmt.Errorf("yunka assembly: register gRPC access/tenant_audit_management: %w", err)
	}
	if applications.AccessTenantDelegationManagement == nil {
	...
	if applications.AccessTenantProfileManagement == nil {
		return errors.New("yunka assembly: application access/tenant_profile_management is required for transport registration")
	}
	if err := accessrest.RegisterTenantProfileManagementOperationExecutor(bindings.HTTP, applications.AccessTenantProfileManagement, executor); err != nil {
		return fmt.Errorf("yunka assembly: register HTTP access/tenant_profile_management: %w", err)
	}
	if err := accessrpc.RegisterTenantProfileManagementOperationExecutor(bindings.RPC, applications.AccessTenantProfileManagement, executor); err != nil {
		return fmt.Errorf("yunka assembly: register gRPC access/tenant_profile_management: %w", err)
	}
	if applications.AccessTenantRolePermission == nil {
