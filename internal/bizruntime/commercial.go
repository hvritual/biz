...
func (factory applicationFactories) BuildCommercialEntitlementManagement(dependencies generatedassembly.CommercialEntitlementManagementDependencies) (commercialapp.EntitlementManagementApplication, error) {
	return entitlementmanagement.Build(commercialpersistence.NewEntitlementTimeRepositoryFactory(), entitlementCapabilities{catalog: dependencies.CommercialModuleCatalog, tenants: dependencies.AccessTenantLifecycle}, nil, factory.snapshots, factory.permissionVersions)
}
