...
type planCapabilities struct{catalog app.PlanManagementToCommercialModuleCatalogChildCapability}
func(c planCapabilities) CommercialModuleCatalog() app.PlanManagementToCommercialModuleCatalogChildCapability{return c.catalog}
