...
func (f applicationFactories) BuildCommercialProvisioning(d assembly.CommercialProvisioningDependencies) (app.ProvisioningApplication, error) {
	...
	if f.provisioningRunner != nil {
		f.provisioningRunner.application = application
	}
	return application, nil
}

type provisioningCapabilities struct {
	changes app.ProvisioningToCommercialSubscriptionChangesChildCapability
}

func (c provisioningCapabilities) CommercialSubscriptionChanges() app.ProvisioningToCommercialSubscriptionChangesChildCapability {
	return c.changes
}
