...
func(c subscriptionChangeCapabilities)CommercialPlanManagement()app.SubscriptionChangesToCommercialPlanManagementChildCapability{return c.plan}
func(c subscriptionChangeCapabilities)CommercialModuleCatalog()app.SubscriptionChangesToCommercialModuleCatalogChildCapability{return c.catalog}
