...
func Build(repositories requestscope.RepositoryFactory[ports.EntitlementRepositories], capabilities commercialapp.EntitlementManagementCapabilities, sources []ports.EntitlementSourceProvider, snapshots ports.EntitlementSnapshotReader, permissions ports.PermissionVersionReader) (commercialapp.EntitlementManagementApplication, error) {
	return usecase.New(repositories, capabilities, sources, snapshots, permissions)
}
