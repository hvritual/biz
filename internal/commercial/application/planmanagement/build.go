...
func Build(repositories requestscope.RepositoryFactory[ports.PlanRepositories], capabilities app.PlanManagementCapabilities)(app.PlanManagementApplication,error){return usecase.New(repositories,capabilities)}
