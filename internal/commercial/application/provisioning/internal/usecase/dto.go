...
func taskDTO(t p.Task) *v1.ProvisioningTaskDTO {
	...
	if c := t.Completion; c != nil {
		out.Completion = &v1.ProvisioningCompletionDTO{ChangeId: c.ChangeID, SubscriptionRevision: c.SubscriptionRevision, SourceVersion: c.SourceVersion, EntitlementVersion: c.EntitlementVersion, AppliedAt: instant(c.AppliedAt)}
	}
	return out
}
