...
func planManagementPolicies() map[string]authz.Policy {
	return map[string]authz.Policy{
		"/commercial.v1.PlanManagementApplication/CheckPlanEligibility": {Operation: OperationPlanManagementCheckPlanEligibility, Permissions: []authz.PermissionKey{"commercial.catalog.read", "platform.plan.read"}, Mode: authz.PermissionAll, Authentication: []string{"api-key", "web-session"}},
		"/commercial.v1.PlanManagementApplication/CreatePlanDraft":      {Operation: OperationPlanManagementCreatePlanDraft, Permissions: []authz.PermissionKey{"commercial.catalog.read", "platform.plan.manage"}, Mode: authz.PermissionAll, Authentication: []string{"api-key", "web-session"}},
