...
type ProvisioningPolicy interface {Requirements(context.Context,plan.Version)([]p.Requirement,error)}
type DatabaseOnlyProvisioning struct{}
func(DatabaseOnlyProvisioning)Requirements(context.Context,plan.Version)([]p.Requirement,error){return nil,nil}
...
type RegisteredPreparation struct {AdapterID string; Version string; Adapter PreparationAdapter}
...
type ProvisioningRepositories struct {Tasks ProvisioningRepository; Events OutboxRepository}
