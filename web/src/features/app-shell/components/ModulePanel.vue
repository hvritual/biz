...
@media (max-height: 800px) {
  ...
  .menu-art img { height: 103px; }
  .menu-art p { max-width: 245px; }
}
@media (max-width: 767px) {
  .module-panel { width: calc(100vw - var(--rail-collapsed-width)); min-width: 0; padding: 20px 16px; }
  ...
  .menu-art h3 { font-size: 14px; }
  .menu-art p { max-width: 145px; }
  .module-heading h2 { font-size: 20px; }
  .module-heading p { font-size: 11px; }
}
</style>
