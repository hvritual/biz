...
const localeMessages = {
  'zh-CN': { ...messages['zh-CN'], appearance: appearanceMessages['zh-CN'], backendTerms: backendTermMessages['zh-CN'], navigation: { ...messages['zh-CN'].navigation, enterprise: { ...messages['zh-CN'].navigation.enterprise, branding: brandingMessages['zh-CN'].navigation } }, branding: brandingMessages['zh-CN'], members: { ...messages['zh-CN'].members, scopes: memberScopeMessages['zh-CN'], profile: memberDetailMessages['zh-CN'] } },
  'en-US': { ...messages['en-US'], appearance: appearanceMessages['en-US'], backendTerms: backendTermMessages['en-US'], navigation: { ...messages['en-US'].navigation, enterprise: { ...messages['en-US'].navigation.enterprise, branding: brandingMessages['en-US'].navigation } }, branding: brandingMessages['en-US'], members: { ...messages['en-US'].members, scopes: memberScopeMessages['en-US'], profile: memberDetailMessages['en-US'] } },
}
