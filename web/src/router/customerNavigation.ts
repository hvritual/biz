...
const customersDomain: Domain = {
  ...
  links: [
    { id: 'overview', label: '客户总览', icon: 'customer', path: '/customers', group: '客户管理' },
    { id: 'contacts', label: '联系人与协作', icon: 'users', path: '/customers/contacts', group: '客户管理' },
    { id: 'sharing', label: '客户共享', icon: 'shield', path: '/customers/sharing', group: '客户管理' },
    { id: 'work', label: '客户事项', icon: 'checks', path: '/customers/work', group: '客户协同' },
    { id: 'risks', label: '客户风险', icon: 'warning', path: '/customers/risks', group: '客户协同' },
  ],
  actions: [
...
const successDomain: Domain = {
  ...
  links: [
    { id: 'plans', label: '经营计划', icon: 'calendar', path: '/customers/plans', group: '客户成功' },
    { id: 'automation', label: '自动化规则', icon: 'activity', path: '/customers/automation', group: '客户成功' },
    { id: 'executions', label: '执行记录', icon: 'file', path: '/customers/executions', group: '客户成功' },
    { id: 'workflow', label: '流程与服务时限', icon: 'organization', path: '/customers/workflows', group: '客户成功' },
    { id: 'reports', label: '经营结果', icon: 'chart', path: '/customers/reports', group: '客户成功' },
  ],
  actions: [
...
const rentalDomain: Domain = {
  ...
  links: [
    { id: 'contracts', label: '合同与续约', icon: 'file', path: '/customers/contracts', group: '投放与资产' },
    { id: 'payment', label: '回款跟进', icon: 'order', path: '/rental/payment', group: '计费与结算' },
    { id: 'delivery', label: '投放交付', icon: 'site', path: '/rental/delivery', group: '履约与服务' },
    { id: 'service', label: '服务恢复验证', icon: 'operations', path: '/rental/service', group: '履约与服务' },
    { id: 'return', label: '退租回收', icon: 'back', path: '/rental/returns', group: '履约与服务' },
  ],
  actions: [
...
export const customerDomains: Record<string, Domain> = {
  ...
  'device-operations': {
    ...
    links: [
      { id: 'devices', label: '设备管理', icon: 'device', path: '/workspace/devices', group: '设备资产' },
